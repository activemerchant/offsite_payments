...
class RemoteMollieCreditcardTest < Test::Unit::TestCase
  include OffsitePayments::Integrations

  def setup
    @api_key = fixtures(:mollie_creditcard)[:api_key]
  end

  def test_create_payment_and_check_status
    create_response = MollieCreditcard.create_payment(@api_key,
    ...
    assert_equal 'creditcard', create_response['method']
    ...
    status_response = MollieCreditcard.check_payment_status(@api_key, create_response['id'])
