...
class PaymentHighwayHelperTest < Test::Unit::TestCase
  ...
  def setup
    OffsitePayments::Integrations::PaymentHighway.service_url = "https://v1-hub-staging.sph-test-solinor.com/"
    @helper = PaymentHighway::Helper.new('order-500','cody@example.com', :amount => 500, :currency => 'EUR')
  end
